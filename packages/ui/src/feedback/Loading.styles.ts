...
export const loadingStyles = css`
  ...
  #loading .progress-container {
    ...
    --jolly-progress-shadow:
      0 0 10px
        var(--jolly-loading-progress-glow, rgb(62 124 184 / 50%)),
      0 0 20px
        var(--jolly-loading-progress-glow-subtle, rgb(62 124 184 / 30%)),
      inset 0 1px 0 rgb(255 255 255 / 30%);
    --jolly-progress-shadow-active:
      0 0 15px
        var(--jolly-loading-progress-glow-strong, rgb(62 124 184 / 70%)),
      0 0 30px
        var(--jolly-loading-progress-glow, rgb(62 124 184 / 50%)),
