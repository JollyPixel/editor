...
export interface HighlightBoundingBoxOptions {
  /**
 ...
 */
export class HighlightBoundingBox extends THREE.LineSegments<THREE.BufferGeometry, THREE.LineBasicMaterial> {
  readonly target: THREE.Object3D;

  #fillMesh: THREE.Mesh<THREE.BoxGeometry, THREE.MeshBasicMaterial> | null = null;

  constructor(
    options: HighlightBoundingBoxOptions
  ) {
    const {
      target,
      color = "#ffffff",
