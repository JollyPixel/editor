...
export interface HighlightOutlineOptions {
  /**
 ...
 */
export class HighlightOutline extends THREE.LineSegments<THREE.BufferGeometry, THREE.LineBasicMaterial> {
  constructor(
    options: HighlightOutlineOptions
  ) {
    const {
      target,
      color = "#ffffff",
