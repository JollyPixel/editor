...
describe("constructor", () => {
  ...
  test("applies the given color and opacity", () => {
    const box = new HighlightBoundingBox({ target: createGroupOfTwoBoxes(), color: "#ff0000", opacity: 0.4 });
  ...
  test("xray disables depth test/write and raises the render order above default objects", () => {
    const box = new HighlightBoundingBox({ target: createGroupOfTwoBoxes(), xray: true });
...
describe("fillOpacity", () => {
  ...
  test("builds a fill mesh on demand, matching the wireframe's current color and x-ray state", () => {
    const box = new HighlightBoundingBox({ target: createGroupOfTwoBoxes(), color: "#ff00ff", xray: true });
...
describe("color", () => {
  test("updates the material color", () => {
    const box = new HighlightBoundingBox({ target: createGroupOfTwoBoxes(), color: "#000000" });
    box.color = "#00ff00";
