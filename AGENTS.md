...
JollyPixel Editor is a monorepo for a collaborative 3D HTML5 game maker (ECS framework on Three.js, browser/Electron runtime, editor tools, MCP server). See [ARCHITECTURE.md](./ARCHITECTURE.md) for the repository layout.
